...
Then read `.claude/skills/bmad-agent-ux-designer/SKILL.md` and follow ALL instructions (skip the Dashboard Update section there since you already did it above).
